"""
Aplicação em python com o framework Flask e um banco de dados SQLAlchemy
"""
...
class ListaPessoa(Resource):
    def get(self):
        pessoas = Pessoas.query.all()  # nao é um bom método
...
class ListaAtividade(Resource):
    def get(self):
        ...
        response = [{'id':i.id, 'nome':i.nome, 'pessoa':i.pessoa} for i in atividade]
        return response
